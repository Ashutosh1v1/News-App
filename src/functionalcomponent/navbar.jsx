        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <Link className="nav-link text-light  active" aria-current="page" to="/politics" onClick={() => { props.changeSearch("") }}>Politics</Link>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item text-light">
                <div className="form-check form-switch mt-2">
                  <input className="form-check-input" type="checkbox" role="switch" id="languageselect" onChange={changelanguage} />
            ...
            <form className="d-flex" role="search" onSubmit={PostData} >
              <input className="form-control me-2" type="search" name="search" value={search} onChange={getInputData} placeholder="Search" aria-label="Search" />
